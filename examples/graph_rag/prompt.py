...
ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT_SYSTEM_MSFT = """
-Goal-
Given a text document that is potentially relevant to this activity and a list of entity types, identify all entities of those types from the text and all relationships among the identified entities.
...
ENTITY_RELATIONSHIPS_GENERATION_JSON_PROMPT_USER_MSFT = """
-Real Data-
######################
entity_types: {{entity_types}}
text: {{input_text}}
...
entity_types = ["PERSON", "ORG", "GPE", "LOC", "PRODUCT", "EVENT", "WORK_OF_ART", "LAW", "LANGUAGE", "DATE",
                "TIME", "PERCENT", "MONEY", "QUANTITY", "ORDINAL", "CARDINAL"]

# Huggingface Phi 3 Mini 4k Instruct Graph Prompts
