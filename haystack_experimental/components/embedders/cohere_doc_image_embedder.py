...
class CohereDocumentImageEmbedder:
    """
    A component for computing Document embeddings based on images.
    ...
    def __init__(
        ...
        *,
        ...
        :param meta_field_for_image_path: the field in the Document metadata that contains the path to the image.
