...
class ToolBreakpoint(Breakpoint):
    ...
    def __str__(self):
        if self.tool_name:
            return f"ToolBreakpoint(component_name={self.component_name}, visit_count={self.visit_count}, tool_name={self.tool_name})"
        else:
            return f"ToolBreakpoint(component_name={self.component_name}, visit_count={self.visit_count}, tool_name=ALL_TOOLS)"
