...
from haystack_experimental.dataclasses import ChatMessage, ChatRole, TextContent
from ollama._types import ResponseError

from haystack_experimental.components.generators.ollama.chat.chat_generator import OllamaChatGenerator
...
def chat_messages() -> List[ChatMessage]:
    return [
        ...
        ChatMessage.from_assistant(
            text="Super Mario has prevented Bowser from destroying the world", meta={"something": "something"}
        ),
    ]
