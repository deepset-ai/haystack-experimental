...
class TestEmbeddingBasedDocumentSplitter:
    ...
    def test_warm_up(self):
        ...
        with patch(
                'haystack_experimental.components.preprocessors.embedding_based_document_splitter.SentenceSplitter') as mock_splitter_class:
            mock_splitter = Mock()
    ...
    def test_no_extra_whitespaces_between_sentences(self):
        ...
        assert split_docs[
                   0].content == "The weather today is beautiful. The sun is shining brightly. The temperature is perfect for a walk. There are no clouds and no rain. "
        assert split_docs[
                   1].content == "Machine learning has revolutionized many industries. Neural networks can process vast amounts of data. Deep learning models achieve remarkable accuracy on complex tasks."
...
Artificial intelligence is transforming education by enabling personalized learning experiences. AI systems can adapt to individual student needs, providing customized content and pacing. Intelligent tutoring systems can provide immediate feedback and support to students, helping them learn more effectively. Additionally, AI can help educators by automating administrative tasks and providing insights into student performance and learning patterns."""
    ...
    def test_max_length_respected_with_forced_word_boundary_splitting(self):
        ...
        text = (
            ...
            "Intelligent systems can perform tasks that typically require human intelligence. "
            "Human intelligence includes learning, reasoning, and problem-solving. "
            "Problem-solving is a key aspect of both human and artificial intelligence. "
            "Intelligence can be measured in various ways and contexts. "
            "Context is important for understanding intelligence and learning. "
            "Learning involves acquiring knowledge and skills over time. "
            "Time is a crucial factor in both natural and artificial learning processes. "
            "Processes can be automated using machine learning algorithms. "
            "Algorithms are step-by-step procedures for solving problems. "
            "Problems can be simple or complex depending on their nature. "
            "Nature provides many examples of intelligent behavior in animals. "
            "Animals exhibit various forms of learning and adaptation. "
            "Adaptation is essential for survival in changing environments. "
            "Environments can be physical, digital, or conceptual in nature. "
            "Nature inspires many artificial intelligence approaches and methods. "
            "Methods for creating intelligent systems continue to evolve rapidly. "
            "Rapidly evolving technology creates new opportunities and challenges. "
            "Challenges in AI include ethical considerations and safety concerns. "
            "Safety concerns are particularly important for autonomous systems. "
            "Autonomous systems must make decisions without human intervention. "
            "Intervention may be necessary when systems encounter unexpected situations. "
            "Situations that require human judgment often involve complex ethical decisions. "
            "Decisions made by AI systems can have significant real-world impacts. "
            "Impacts can be positive or negative depending on the application. "
            "Applications of AI span across many different industries and domains. "
            "Domains such as healthcare, finance, and transportation benefit from AI. "
            "Transportation systems are becoming increasingly automated and intelligent. "
            "Intelligent transportation systems can improve safety and efficiency. "
            "Efficiency improvements can lead to reduced costs and environmental impact. "
            "Environmental impact is an important consideration in technology development. "
            "Development of AI systems requires careful planning and testing. "
            "Testing ensures that systems behave as expected in various scenarios. "
            "Scenarios should include both normal operation and edge cases. "
            "Edge cases often reveal weaknesses in system design and implementation. "
            "Implementation details can significantly affect system performance and reliability. "
            "Reliability is crucial for systems that operate in safety-critical environments. "
            "Environments with high stakes require robust and trustworthy AI systems. "
            "Systems that are trustworthy inspire confidence in their users and stakeholders. "
            "Stakeholders include end users, developers, regulators, and society at large. "
            "Society must balance the benefits and risks of AI technology adoption. "
            "Adoption of new technologies often follows predictable patterns and cycles. "
            "Cycles of innovation typically involve periods of hype and disillusionment. "
            "Disillusionment can lead to more realistic expectations and better implementations. "
            "Implementations that address real needs tend to be more successful and sustainable. "
            "Sustainable development practices are important for long-term success. "
        )
