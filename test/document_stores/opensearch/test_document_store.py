...
class TestDocumentStore(DocumentStoreBaseTests):
    ...
    def document_store_readonly(self, request):
        ...
        store._ensure_initialized()
        assert store._client
        store._client.cluster.put_settings(
    ...
    def test_create_index(self, document_store_readonly: OpenSearchDocumentStore):
        ...
        assert document_store_readonly._client.indices.exists(
    ...
    @patch("haystack_experimental.document_stores.opensearch.document_store.bulk")
...
class TestDocumentStoreAsync:
    ...
    async def test_write_documents(self, document_store: OpenSearchDocumentStore):
        docs = [Document(id="1")]
        assert await document_store.write_documents_async([Document(id="2")]) == 1
